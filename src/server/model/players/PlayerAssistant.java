	...
	**/
	...
	public void addStarter() {
		if (!Connection.hasRecieved1stStarter(Server.playerHandler.players[c.playerId].connectedFrom)) {
			c.getItems().addItem(995,500000); //money
			c.getItems().addItem(1101,1);//iron chain 
			c.getItems().addItem(1067,1);//iron legs
			c.getItems().addItem(1137,1);//iron med
			c.getItems().addItem(1175,1);//iron sq
			c.getItems().addItem(1321,1);//bronze scim
			c.getItems().addItem(841,1);//shortbow
			c.getItems().addItem(1095,1);//l chaps
			c.getItems().addItem(1129,1);//l body
			c.getItems().addItem(882,500);//bronze arrows
			c.getItems().addItem(556,100);//air runes
			c.getItems().addItem(554,100);//fire runes
			c.getItems().addItem(555,100);//water runes
			c.getItems().addItem(557,100);//earth runes
			c.sendMessage("Welcome to MarauderScape! Exciting adventures await you!");
			c.sendMessage("@red@Brought to you by the awesomeness of Colin");
		}
	}
